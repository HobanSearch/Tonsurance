    ...
    <div className="space-y-6">
      ...
      {step === 4 && (
        <div className="space-y-4">
          ...
          {/* Protection Coverage */}
          <div className="border-3 border-copper-500 bg-copper-50/30 p-4 space-y-4">
            <div>
              <label className="flex items-center gap-3 cursor-pointer">
                ...
                <div>
                  <div className="text-text-secondary font-mono text-sm font-semibold">
                    🛡️ Enable Parametric Risk Coverage
                  </div>
                  <div className="text-xs text-text-tertiary">
                    Protect your escrow with parametric coverage
                  </div>
                </div>
              </label>
            </div>
              ...
              <div className="space-y-3 pl-8">
                <div>
                  ...
                  <div className="space-y-2">
                    <label className="flex items-start gap-3 cursor-pointer p-3 border-2 border-cream-400 hover:bg-cream-300 transition-all">
                      <input
                        type="radio"
                        name="coverageType"
                        value="smart_contract"
                        checked={coverageType === 'smart_contract'}
                        onChange={(e) => setCoverageType(e.target.value as any)}
                        className="mt-1"
                      />
                      <div className="flex-1">
                        <div className="font-mono text-sm font-semibold text-text-primary">
                          Smart Contract Exploit (0.8% APR)
                        </div>
                        <div className="text-xs text-text-tertiary">
                          Coverage for verified contract exploits and hacks
                        </div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer p-3 border-2 border-cream-400 hover:bg-cream-300 transition-all">
                      <input
                        ...
                        name="coverageType"
                        value="timeout"
                        checked={coverageType === 'timeout'}
                        onChange={(e) => setCoverageType(e.target.value as any)}
                        className="mt-1"
                      />
                      <div className="flex-1">
                        <div className="font-mono text-sm font-semibold text-text-primary">
                          Timeout Dispute (0.5% APR)
                        </div>
                        <div className="text-xs text-text-tertiary">
                          Coverage for escrow timeout disputes and arbitration
                        </div>
                      </div>
                    </label>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer p-3 border-2 border-cream-400 hover:bg-cream-300 transition-all">
                      ...
                      <div className="flex-1">
                        <div className="font-mono text-sm font-semibold text-text-primary">
                          Comprehensive (1.2% APR)
                        </div>
                        <div className="text-xs text-text-tertiary">
                          Full coverage: Contract exploits, timeouts, and oracle failures
                        </div>
                      </div>
                    </label>
                  </div>
                ...
                {/* Premium Display */}
                <div className="border-2 border-copper-500 bg-cream-200 p-3">
                  <div className="flex justify-between items-center font-mono text-sm">
                    <span className="text-text-tertiary">Coverage Premium:</span>
                    <span className="text-terminal-green font-bold text-lg">
                      ${coveragePremium.toFixed(2)}
                    </span>
                  </div>
                  <div className="text-xs text-text-tertiary mt-1">
                    One-time fee for {timeoutDays} days of coverage
                  </div>
                </div>

                <InfoPanel variant="info">
                  <div className="font-mono text-xs">
                    &gt; Coverage premium is paid by the payer at escrow creation
                    <div className="mt-1">
                    &gt; Payouts are triggered automatically if covered events occur
                    </div>
                  </div>
                </InfoPanel>
              </div>
