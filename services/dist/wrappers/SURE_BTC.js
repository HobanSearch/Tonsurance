...
exports.SURE_BTC = void 0;
exports.sure_btc_ConfigToCell = sure_btc_ConfigToCell;
const core_1 = require("@ton/core");
function sure_btc_ConfigToCell(config) {
...
class SURE_BTC {
    ...
    static createFromConfig(config, code, workchain = 0) {
        ...
        return new SURE_BTC((0, core_1.contractAddress)(workchain, init), init);
    }
