...
exports.SURE_JNR_PLUS = void 0;
exports.sure_jnr_plus_ConfigToCell = sure_jnr_plus_ConfigToCell;
const core_1 = require("@ton/core");
function sure_jnr_plus_ConfigToCell(config) {
...
class SURE_JNR_PLUS {
    ...
    static createFromConfig(config, code, workchain = 0) {
        ...
        return new SURE_JNR_PLUS((0, core_1.contractAddress)(workchain, init), init);
    }
...
exports.SURE_JNR_PLUS = SURE_JNR_PLUS;
